        ...
        if (this.state.currency === 'USD') {
            list =
                <li className="list-group-item">
                    Bitcoin valendo no {this.props.bpi.USD.description}
                    : <span className="bagde badge-primary">
            ...
            list =
                <li className="list-group-item">
                    Bitcoin valendo no {this.props.bpi.GBP.description}
                    : <span className="bagde badge-primary">
            ...
            list =
                <li className="list-group-item">
                    Bitcoin valendo no {this.props.bpi.EUR.description}
                    : <span className="bagde badge-primary">
